  ...
  return (
    ...
    flex-wrap gap-4 text-slate-700'>
      ...
      border border-gray-200'>
        ...
        <input onChange={(e) => setInput(e.target.files[0])} type="file" accept='application/pdf' className='w-full p-2 px-3 mt-2 outline-none
      ...
      flex-col border border-gray-200 min-h-96 max-h-[600px]'>
        <div className='flex items-center gap-3'>
          ...
          <h1 className='text-xl font-semibold'>Analysed Results</h1>
        </div>
        ...
        <div className='flex-1 flex justify-center items-center'>
          ...
          text-gray-500'>
            ...
            <p>Upload your Resume and click "Review Resume" to see the result</p>
