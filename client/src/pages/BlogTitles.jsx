...
const BlogTitles = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      setLoading(true)
      const prompt = `Generate 5 creative, catchy and human sounding blog titles with a maximum of 70 characters for a blog post about ${input} in the category ${selectedCategory}`
