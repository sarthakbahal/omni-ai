...
const WriteArticle = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try{
      setLoading(true)
      const prompt = `Write a detailed, creative and human sounding SEO-friendly blog article on the topic ${input} in ${selectedLength.text}`
      ...
      if(data.success){
        ...
        toast.error(data.message || 'Could not generate article. Please try again.')
      }
    }catch(error){
